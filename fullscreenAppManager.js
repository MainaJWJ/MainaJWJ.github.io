...
class FullscreenAppManager {
  ...
  launchApp(options) {
    ...
    windowEl.style.cssText = `width: 100%; height: calc(100% - 30px); position: absolute; top: 0; left: 0; display: flex; flex-direction: column;`;
  ...
  focusWindow(windowId) {
    ...
    // 전체화면 앱은 최상단에 표시
    windowInfo.element.style.zIndex = '1000';
